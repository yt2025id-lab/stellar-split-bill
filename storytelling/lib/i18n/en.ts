...
export const en: Dict = {
  ...
  hero: {
    badge: "Split Bill · On-Chain Expense Sharing",
    titleLine1: "Split",
    titleLine2: "Bills",
    titleLead: "on",
    lead: "No more awkward chasing. No more disputed payments.",
    leadStrong: "Just smart contracts that settle everything.",
    features: "Even splits · On-chain settlement · Zero trust required",
    ...
    ticker: ["Zero awkward chats", "No chasing friends", "Even splits always", "100% on-chain", "Inter-contract magic", "Instant settlement", "No treasurer needed", "Fully auditable"],
    scrollCue: "Scroll",
  },
  akar: {
